    ...
    function Pay() {
        ...
        if (order.fullname == '') {
            ...
            iziToast.warning({
                timeout: 1500,
                title: 'Cảnh báo',
                message: 'Mời bạn chọn tỉnh thành.',
                position: 'topRight'
            });
        }
            ...
            iziToast.warning({
                timeout: 1500,
                title: 'Cảnh báo',
                message: 'Mời bạn chọn quận/huyện.',
                position: 'topRight'
            });
        }
        else if ($('#town').val() == '-1') {
            iziToast.warning({
                timeout: 1500,
                title: 'Cảnh báo',
                message: 'Mời bạn chọn phường/xã.',
                position: 'topRight'
            });
        }
        else if ($('#cart-town').val() == '') {
            iziToast.warning({
                timeout: 1500,
                title: 'Cảnh báo',
                message: 'Mời bạn nhập số nhà/thôn/xóm.',
                position: 'topRight'
            });
        }
        else {
