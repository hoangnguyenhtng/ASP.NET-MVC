...
namespace Do_An_KDCLPM.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Detail(string alias)
        {
            ...
            productdetail.lstProducts_Categories = db.products.Where(x => x.id != productdetail.product.id && x.category.name.Equals(productdetail.product.category.name)).ToList();
